...
## 📊 Engenharia de Dados (Em Formação)
...
## 🎓 Liderança Técnica e Educação

Além da atuação técnica, desenvolvo iniciativas de capacitação com foco em aplicação prática e simulação de cenários reais de mercado.
...
- Implantação de Apache, PHP e MariaDB  
- Instalação e configuração do GLPI  
- Segurança com SSH e firewall  
